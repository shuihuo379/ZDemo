 ...
 * @date 2016/09/01
 */
public class H264DecodeActivity extends Activity{
	...
	private final static String FILE_NAME = "camera.h264"; //h264编码后的文件名(需要解码后观看)

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.surface_decode_activity);
