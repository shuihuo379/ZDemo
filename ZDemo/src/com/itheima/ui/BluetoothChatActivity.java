...
import com.itheima.adapter.ChatMsgViewAdapter;
import com.itheima.demo.R;
import com.itheima.model.ChatMsgEntity;
import com.itheima.service.BluetoothChatService;
...
public class BluetoothChatActivity extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter(); //得到一个本地蓝牙适配器
	    //判断有没有蓝牙设备
	...
	private void initData() {
	   mChatAdapter = new ChatMsgViewAdapter(this, mDataArrays);
