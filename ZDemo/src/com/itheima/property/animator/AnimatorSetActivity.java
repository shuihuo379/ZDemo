...
public class AnimatorSetActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.anim_set_activity);
		
		mBlueBall = (ImageView) findViewById(R.id.id_ball);
	}
	
	public void togetherRun(View view){
		ObjectAnimator anim1 = ObjectAnimator.ofFloat(mBlueBall,"scaleX",1.0f,2.0f);
		ObjectAnimator anim2 = ObjectAnimator.ofFloat(mBlueBall,"scaleY",1.0f,2.0f);
	...
	public void playWithAfter(View view){
		...
		//ObjectAnimator anim4 = ObjectAnimator.ofFloat(mBlueBall,"x",cx);  //此时cx代表终点值,起点值为当前所处位置
