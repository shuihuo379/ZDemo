...
public class SlideOriginalListView extends ListView{
	/**
	...
	public SlideOriginalListView(Context context) {
		this(context, null);
	}

	public SlideOriginalListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SlideOriginalListView(Context context, AttributeSet attrs, int defStyle) {
