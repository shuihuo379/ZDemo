...
public class TagCloudLinkView extends RelativeLayout{
    ...
    private static final int DEFAULT_TAG_LAYOUT_COLOR = Color.parseColor("#84BB43");
    private static final int DEFAULT_TAG_TEXT_COLOR = Color.parseColor("#666666");
    private static final int DEFAULT_DELETABLE_TEXT_COLOR = Color.parseColor("#666666");
    ...
    private void initialize(Context ctx, AttributeSet attrs, int defStyle) {
        ...
        // get AttributeSet
        TypedArray typeArray = ctx.obtainStyledAttributes(attrs, R.styleable.MyTagCloudLinkView, defStyle, defStyle);
        mTagLayoutColor = typeArray.getColor(
                R.styleable.MyTagCloudLinkView_tagLayoutColor,DEFAULT_TAG_LAYOUT_COLOR);
        mTagTextColor = typeArray.getColor(
                R.styleable.MyTagCloudLinkView_tagTextColor,DEFAULT_TAG_TEXT_COLOR);
        mTagTextSize = typeArray.getDimension(
                R.styleable.MyTagCloudLinkView_tagTextSize,DEFAULT_TEXT_SIZE);
        mIsDeletable = typeArray.getBoolean(
                R.styleable.MyTagCloudLinkView_isDeletable, false);
        mDeletableTextColor = typeArray.getColor(
                R.styleable.MyTagCloudLinkView_deletableTextColor,DEFAULT_TAG_TEXT_COLOR);
        mDeletableTextSize = typeArray.getDimension(
                R.styleable.MyTagCloudLinkView_deletableTextSize,DEFAULT_DELETABLE_TEXT_COLOR);
    }
    ...
    public void drawTags() {
        ...
        for (Tag item : mTags) {
            ...
            // inflate tag layout
            View tagLayout = (View) mInflater.inflate(R.layout.cloud_tag, null);
