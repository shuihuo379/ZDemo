...
//			urlConn.connect();
	...
	public static  String postByHttpURLConnection(String httpurl,StringBuffer params){
		String str = "";
		try {
			URL url = new URL(httpurl);
			HttpURLConnection conn = (HttpURLConnection) url.openConnection();
			conn.setConnectTimeout( 4 * 1000 );// 设置连接超时
	...
	public static  String getByHttpURLConnection(String httpurl){
		String str = "";
		try {
			URL url = new URL(httpurl);
			HttpURLConnection conn = (HttpURLConnection) url.openConnection();
