...
public class SharePopWindow extends PopupWindow{
	...
	private OnClickSharePlatformSelect listener;
	...
	public void init() {
		View view = LayoutInflater.from(activity).inflate(R.layout.share_pop_window, null, false);
	 ...
	 * @return the listener
	 */
	public OnClickSharePlatformSelect getListener() {
		return listener;
	}
	 ...
	 */
	public void setListener(OnClickSharePlatformSelect listener) {
